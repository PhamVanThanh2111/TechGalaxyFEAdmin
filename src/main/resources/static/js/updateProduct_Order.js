...
const createProductCard = (count, orderDetail) => {
    ...
    const productOptions = `
        ...
        <option value="${orderDetail.id}" ${productName ? "selected" : ""}>${productName}</option>
    `;
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control product-select" id="productName-${count}" data-id="${count}" name="productName[${count}]" disabled>
                            ${productOptions}
                        </select>
                    </div>
                    <div class="mb-3">
...
const handleQuantityChange = (count) => {
    ...
    if (quantityInput) {
        quantityInput.addEventListener('input', () => {
            ...
            updateRemaining(count); // Cập nhật remaining (số lượng còn lại)
        });
    }
};
