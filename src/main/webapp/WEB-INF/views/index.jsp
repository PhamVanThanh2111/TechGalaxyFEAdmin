            ...
            <li class="nav-item">
                ...
                <div id="userManage" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="html/showCustomer.jsp">Show</a>
                        <a class="collapse-item" href="html/addCustomer.jsp">Add</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="phoneManage" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./html/showPhone.html">Show</a>
                        <a class="collapse-item" href="./html/addPhone.html">Add</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="orderManage" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./html/showOrder.html">Show</a>
                        <a class="collapse-item" href="./html/addOrder.html">Add</a>
                    </div>
                </div>
            </li>
